// Example HomePage from this project,
// which is using this module in old version
// What do you have to remember about?
// 1. You have to send data by param to Sections(TheRoot) component
// 2. This component will choose proper layout from available
//     a) Remember about good path to this component, it is in module directory!
// 3. There is also mixin which has 2 tasks
//     a) Loads needed data from WP in asyncData (SSR!)
//     b) Gives us wpData of current section via computed: wpData
...
import MessengerChat from '../../../modules/vsf-messenger-chat/components/MessengerChat'

import Sections from '../../../modules/wp-rest-content/sections/TheRoot'
import loadSections from '../../../modules/wp-rest-content/mixins/loadSections'

export default {
  mixins: [Home, loadSections],
  components: {
    HeadImage,
    Onboard,
    ProductListing,
